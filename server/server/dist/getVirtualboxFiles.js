...
const getVirtualboxFiles = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const virtualboxRes = yield fetch(`https://storage.mzli.workers.dev/api?virtualboxId=${id}`);
        ...
        for (let i = 0; i < parts.length; i++) {
            ...
            if (existing) {
                ...
                if (isFile) {
                    ...
                    const folder = { id: path, type: "folder", name: part, children: [] };
...
const fetchFileContent = (fileId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const fileRes = yield fetch(`https://storage.mzli.workers.dev/api?fileId=${fileId}`);
